...
definePages();
$result=init(DB_HOST,DB_USER,DB_PASSWORD,DB_NAME,"books","bookName");
?>
<head>
    <meta charset="UTF-8">
                ...
                <center>
                    ...
                    <div class="wrap">
                        ...
                        <button style="margin-left: 100px;"
                            class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect" id='id_searchBtn'>
