  ...
  <div class="mdl-layout mdl-js-layout mdl-layout--fixed-header mdl-layout--fixed-tabs">
    <header class="mdl-layout__header">
      ...
      <div class="mdl-layout__tab-bar mdl-js-ripple-effect">
        ...
        <a href="#fixed-tab-gpt" class="mdl-layout__tab">GPT3.5</a>
      </div>
    </header>
    ...
    <main class="mdl-layout__content">
        ...
        <div class="page-content">
          <center>
              ...
              <form action="" method="post" name="editResources">
                ...
                <div class="mdl-textfield mdl-js-textfield">
                  <input class="mdl-textfield__input" type="text" name="link"
                    ...
                    onkeyup="autoLoadFilmNameAndExtractCode(this)">
                ...
                <div class="mdl-textfield mdl-js-textfield">
                  <input class="mdl-textfield__input" type="text" name="extractCode" id="id_edit_extractCode"
                    onkeyup="autoLoadFilmNameAndExtractCode2(this)">
                ...
                <div class="mdl-textfield mdl-js-textfield">
                  <textarea class="mdl-textfield__input" type="text" name="notes" id="id_edit_notes"></textarea>
            ...
            <form action="books.php?act=insert" method="post">
              ...
              <span style="color: #429488;padding-right: 20px;" class="material-icons">auto_stories</span>
              <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                <input class="mdl-textfield__input" type="text" name="bookName" required="required" id="id_mediaName">
          ...
          <center>
            ...
            <div class="editForm">
              ...
              <form action="" method="post" name="editResources">
                ...
                <div class="mdl-textfield mdl-js-textfield">
                  <input class="mdl-textfield__input" type="text" name="serialName" id="id_edit_mediaName">
                  <label class="mdl-textfield__label" for="id_edit_mediaName"></label>
                </div>
                <br>
                <span style="color: #429488;padding-right: 20px;" class="material-icons">add_link</span>
            ...
            <form action="serial.php?act=insert" method="post">
              ...
              <span style="color: #429488;padding-right: 20px;" class="material-icons">live_tv</span>
              <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                <input class="mdl-textfield__input" type="text" name="serialName" required="required" id="id_mediaName">
      ...
      <section class="mdl-layout__tab-panel" id="fixed-tab-gpt">
        <div class="page-content">
