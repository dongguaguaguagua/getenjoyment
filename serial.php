...
Fuzzysearch.prototype={
    ...
    ,renderTab:function(list){
        ...
        for(var i=0,len=list[1].length;i<len;i++){
             ...
             <td style=\"width:3%\"><button class=\"mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect\" onclick=\"window.location.href='http://localhost:8080/resources/serial.php?act=delete&delateObject="+list[1][i]+"'\">删除</button></td>\
             </tr>";
        }
        colStr+="</tbody>";
