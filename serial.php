...
<body>
    ...
    <form action="serial.php?act=insert" method="post">
        ...
        <br>电视剧名称
         <input type="txt" name="serialName" required="required"/>
        <br>链接
...
Fuzzysearch.prototype={
      init :function(){
        ...
        searchFn:function(){
            ...
            location.href="serial.php"+"?act=search&keyWord="+keyWord;
        }
