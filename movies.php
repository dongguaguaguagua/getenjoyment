...
?>;
    ...
    Fuzzysearch.prototype = {
        ...
        renderTab: function(list) {
            ...
            <td style=\"width:3%\"><button class=\"mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect\" onclick=\"window.location.href='/resources/movies.php?act=delete&delateObject="+ list[1][i] + "'\">删除</button></td>\
            </tr>";
            }
            colStr += "</tbody>";
