...
<body>
    ...
    <form action="variety_show.php?act=insert" method="post">
        ...
        <br>综艺名称
         <input type="txt" name="showName" required="required"/>
        <br>链接
...
Fuzzysearch.prototype={
    ...
    searchFn:function(){
        ...
        location.href="variety_show.php"+"?act=search&keyWord="+keyWord;
    }
