...
<script>
    ...
    var editItem = function(name) {
        ...
        document.editResources.action = "vareity_show.php?act=edit&name=" + name;
    }
</script>
<script>
    let l = [[], [], [], [], []];
    ...
    Fuzzysearch.prototype = {
        ...
        renderTab: function(list) {
            ...
            <ul class=\"mdl-menu mdl-menu--bottom-right mdl-js-menu mdl-js-ripple-effect\"\
                ...
                <li class=\"mdl-menu__item\" onclick=\"window.location.href='/resources/vareity_show.php?act=delete&delateObject="+ list[1][i] + "'\">删除</li>\
